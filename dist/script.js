...
/* harmony import */ var _card__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./card */ "./src/js/modules/card.js");
...
const vacancy = () => {
  let consultingArr = [],
    ...
    apprentice1Arr = [],
    apprentice2Arr = [];
  (0,_services_requests__WEBPACK_IMPORTED_MODULE_1__.getResource)('./vacancy.json').then(res => {
    ...
    consultingArr.map(_ref => {
      ...
      document.querySelector(`#${category}Cards`).append((0,_card__WEBPACK_IMPORTED_MODULE_2__["default"])(id, category, employer, jobTitle, salary, tags, link, feed, date, res.vacancy));
    });
    ...
    const salarySortArr = (categoryName, arr) => {
      ...
      arr.sort((a, b) => salaryNum(b.salary) - salaryNum(a.salary)).map(_ref6 => {
        ...
        document.querySelector(`#${category}Cards`).append((0,_card__WEBPACK_IMPORTED_MODULE_2__["default"])(id, category, employer, jobTitle, salary, tags, link, feed, res.vacancy));
      });
    };
